...
sresobj.addSwitchAppliance(manufacturer="iHome",name="Air Conditioner",description="AC",device_id="endpoint-ihome-ac")
...
def lambda_handler(event, context):
    ...
    if sreqobj.get_request_name() == "Discover":
        ...
        if sreqobj.get_endpoint_id() == "endpoint-ihome-light1":
        ...
        elif sreqobj.get_endpoint_id() == "endpoint-ihome-light2":
            ...
            return sresobj.buildSwitchResponse(endpoint="endpoint-ihome-ac",powerState="ON",oauthToken=otoken)
